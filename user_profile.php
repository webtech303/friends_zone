			...
			echo"
				<div class='row'>
					...
					<ul class='list-group'>
						...
						<li class='list-group-item' title='User Registration Date'><strong>$register_date</strong></li><br>
					</ul>	
				</div>
			";
				...
				<a href='edit_profile.php?u_id=$userown_id' class='btn btn-success'>Edit Profile</a><br>
				";
			}
					...
					echo"
						<div id='own_posts'>
							<div class='row'>
								...
								<div class='col-sm-6'>
									<h3><a style='text-decoration: none; cursor: pointer; columns: #3897f0' href='user_profile.php?u_id=$user_id'>$user_name</a></h3>
							...
							<div class='row'>
								<div class='col-sm-12'>
									<img id='postss-img' src='imagepost/$upload_image' style='height: 350px'>
								</div>
							</div><br>
