...
<head>
	...
	?>
	<title>Edit Acccount Settings</title>
	<meta charset="utf-8">
							...
							<div class="modal-content">
								...
								<div class="modal-body">
									<form action="recovery.php?id=<?php echo $user_id; ?>" method="post" id="f">
										...
										<pre>Answer the above question we will ask this question is you forgot your <br>password</pre>
										<br><br>
									</form>
									...
									<?php
										...
										echo"<script>window.open('edit_prfile.php?u_id=$user_id','_self')</script>";
										exit();
									}else{
