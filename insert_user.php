...
include("includes/connection.php");
	...
	if(isset($_POST['sign_up'])){
		...
		$rand = rand(1, 3); //Random number between 1 and 3
			...
			if($rand == 1)
				$profile_pic = "black.png";
			else if($rand == 2)
				$profile_pic = "orange.png";
			else if($rand == 3)
				$profile_pic = "blue.png";
		...
		values('$first_name','$last_name','$username','Welcome Friends Zone.This is my default status!','...','$pass','$email','$country','$gender','$birthday','$profile_pic','default_cover.jpg',NOW(),'$status','$posts','Iwantto recover.')";
