		...
		<div class="col-sm-3" id="select_user">
			...
			<div class="col-sm-6">
				<div class="load_msg" id="scroll_messages">
					<?php
						$sel_msg = "select * from user_messages where (user_to='$user_to_msg' AND user_from='$user_from_msg') OR (user_from='$user_to_msg' AND user_to='$user_from_msg') ORDER by 1 DESC";
						...
						?>
						<div id="loaded_msg">
							<p><?php if($user_to == $user_to_msg AND $user_from ==$user_from_msg){echo "<div class='message' id='blue' date-toggle='tooltip' title='$msg_date'>$msg_body</div><br><br><br>";}else if($user_from==$user_to_msg AND $user_to ==$user_from_msg){echo"<div class='message' id='green' date-toggle='tooltip' title='$msg_date'>$msg_body</div><br><br><br> ";} ?></p>	
						</div>
						<?php
				...
				<?php
					...
					if($u_id == "new"){
					echo'
						<form><h3>Select Someone to start conversation</h3>
					...
					<div class='row'>
						...
						<center>
							<div style='background-color: #e6e6e6' class='col-sm-9'>
								...
								<img class='img-circle' src='users/$user_image' width='150' height=''150><be><be>
									<ul class='list-group'>
