...
$con = mysqli_connect("localhost","root","","friends_zone") or die("Connection was not established");
							...
							<div class='col-md-6 col-md-offset-3'>
								<div class='panel panel-info'>
									<div class='panel-body'>
										...
										<button class='btn-btn-info pull-right' name='replay'>Comment</botton>	
										</form>
									</div>
								</div>
							</div>
	...
	function search_user(){
		...
		while ($row_user = mysqli_fetch_array($run_user)) {
			...
			<div class='row'>
				...
				<div class='col-sm-6'>
					<div class='row' id='find_people' style='border:1px solid grey;'>
						<div class='col-sm-3'>
							<a href='user_profile.php?u_id=$user_id'>
								<img src='users/$user_image' width='150px' height='140px' title='$username' style='float:left; margin-left:-15px;'/>
							</a>
						</div><br><br>
						<div class='col-sm-6'>
